...
describe "ApplicationController" do
  describe "homepage: GET /" do
    ...
    it "renders the homepage view, 'home.erb'" do
      expect(last_response.body).to include("Welcome to Recode")
    end
  end
  ...
  describe "user's homepage: GET /users/home" do
    ...
    it "responds with a 200 status code" do
      @user = User.create(:name => "Ron Weasley", :email => "ron@recode.edu", :password => "scabbers")
      visit 'sessions/login'
      fill_in(:email, :with => "ron@recode.edu")
      fill_in(:password, :with => "scabbers")
      click_button "Log In"
      visit '/users/home'
